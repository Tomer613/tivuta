        ...
        <div className="relative select-none" style={{ perspective: '1200px', direction: 'ltr' }}>
            ...
            >
                ...
                {/* TOP-RIGHT: Logo + slogan right-aligned together.
                    marginRight: -9px compensates for ~9px of transparent SVG whitespace
                    on the right side of the viewBox, so the visual ט aligns with the
                    right edge of the slogan below it. */}
