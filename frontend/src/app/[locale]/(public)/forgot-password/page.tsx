...
const translations: Record<string, T> = {
    he: { title: 'שכחת סיסמה?', subtitle: 'נשלח לך קישור לאיפוס הסיסמה למייל הרשום במערכת', email: 'כתובת אימייל', submit: 'שלח קישור איפוס', success: 'אם הכתובת קיימת במערכת, קישור לאיפוס סיסמה נשלח אליה.', back_to_login: 'חזרה להתחברות', error: 'שגיאה בשליחת קישור האיפוס. נסה/י שוב בעוד מספר דקות.' },
    en: { title: 'Forgot Password?', subtitle: "We'll send a reset link to your registered email", email: 'Email Address', submit: 'Send Reset Link', success: 'If that email exists in our system, a reset link has been sent.', back_to_login: 'Back to login', error: 'Failed to send the reset link. Please try again in a few minutes.' },
