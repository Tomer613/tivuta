...
const translations: Record<string, T> = {
    he: { title: 'שכחת סיסמה?', subtitle: 'נשלח לך קישור לאיפוס הסיסמה למייל הכניסה שלך לפורטל הספקים', email: 'כתובת אימייל', submit: 'שלח קישור איפוס', success: 'אם הכתובת קיימת במערכת, קישור לאיפוס סיסמה נשלח אליה.', back_to_login: 'חזרה להתחברות' },
    en: { title: 'Forgot Password?', subtitle: "We'll send a reset link to your vendor portal login email", email: 'Email Address', submit: 'Send Reset Link', success: 'If that email exists in our system, a reset link has been sent.', back_to_login: 'Back to login' },
