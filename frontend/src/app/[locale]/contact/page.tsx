        ...
        return (
            <main className="min-h-[70vh] flex items-center justify-center bg-slate-50 px-8">
                <div className="max-w-md w-full bg-white p-12 rounded-[3rem] shadow-2xl text-center border border-slate-100">
                    ...
                    <h1 className="text-3xl font-black text-slate-900 mb-4">{t.success_title}</h1>
        ...
        <main className="min-h-screen bg-slate-50 py-24 px-8">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="space-y-10 mt-4">
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-1">{t.phone}</h3>
                                <p className="text-slate-500 text-lg">*9876</p>
                                <p className="text-slate-400 text-sm">Sun-Thu | 09:00 - 18:00</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-1">{t.email}</h3>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-1">{t.office}</h3>
                                <p className="text-slate-500 text-lg">{t.office_loc}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-slate-100 relative overflow-hidden">
                    ...
                    <h2 className="text-3xl font-black text-slate-900 mb-8">{t.form_title}</h2>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-600 px-2">{t.name}</label>
                            <input required type="text" className="bg-slate-50 border-none rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all" />
                        </div>

                        <div className="grid grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-bold text-slate-600 px-2">{t.email_label}</label>
                                <input required type="email" className="bg-slate-50 border-none rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-bold text-slate-600 px-2">{t.phone_label}</label>
                                <input required type="tel" className="bg-slate-50 border-none rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all" />
                            </div>
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-600 px-2">{t.subject}</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-bold text-slate-600 px-2">{t.message}</label>
                            <textarea required rows={4} className="bg-slate-50 border-none rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all resize-none"></textarea>
                        </div>
