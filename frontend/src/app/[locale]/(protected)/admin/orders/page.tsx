...
function CalendarView({ lines, onSendReminder, sendingIds }: { lines: FlatLine[]; onSendReminder: (id: number) => void; sendingIds: Set<number> }) {
    ...
    const byDay: Record<number, FlatLine[]> = {};
    lines.forEach((l) => {
