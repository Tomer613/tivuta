...
## Loyalty & Vendor Commission Program (Phases 1–4 — session 2026-07-18/19)

Full design plan: see `.claude/plans` history or ask for the "sparkling-swimming-puffin" plan — this section documents what's actually **built** so far (Phases 1–4 of a 5-phase rollout).
...
### Explicitly NOT built yet (later phase per the plan)
